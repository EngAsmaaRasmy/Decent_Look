@extends('layouts.base' ,['title'=> $subSubCategory->name])
@section('main')
        <main class="main">
        	<div class="page-header text-center" style="background-image: url('{{asset('')}}assets/images/page-header-bg.jpg')">
        		<div class="container">
        			<h1 class="page-title"> @if(App::getlocale()=='ar')
                        {{$subSubCategory->name_ar ?? 'None'}}
                         @else
                        {{$subSubCategory->name ?? 'None'}}
                        @endif</h1>
        		</div><!-- End .container -->
        	</div><!-- End .page-header -->
            <nav aria-label="breadcrumb" class="breadcrumb-nav mb-2">
                <div class="container">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{route('web-site-categories.index')}}">{{trans('site.products')}}</a></li>
                        ...
                        <div class="col-lg-9">
                            <div class="products mb-3">
                                <div class="row justify-content-start">
                                    @if($productsSubSubCategory->isNotEmpty())
                                    @foreach($productsSubSubCategory as $product)
                                        ...
                                        <div class="product product-7 text-center">
                                            ...
                                            <div class="product-body">
                                                <div class="product-cat">
                                                    <a href="{{route ('web-site-sub-categories.show',[$product->subCategory->id ??'None'])}}">
                                                        @if(App::getlocale()=='ar')
                        ...
                        <aside class="col-lg-3 order-lg-first">
                            <div class="sidebar sidebar-shop">
                                <div class="widget widget-clean">
                                    <label>{{trans('site.all_sub_categories')}}</label>
                                            ...
                                            <div class="filter-items filter-items-count">
                                                ...
                                                <div class="filter-item">
                                                    <div class="custom-control custom-checkbox">
                                                        <input type="checkbox" value="{{ $subCategory->id }}" name="sub_category_id[]" class="custom-control-input" id="{{ $subCategory->id }}">
                                                    ...
                                                    <span class="item-count">{{$subCategory->products_count}}</span>
                                                </div><!-- End .filter-item -->   
                                                @endforeach
