...
class SubSubCategory extends Model
{
    ...
    {
        return $this->image ? env('APP_URL') . 'uploads/subSubCategories/' . $this->image : null;
    }
    ...
    {
        $translation = Translation::where('model', 'SubSubCategory')
    ...
    {
        $slug = Slug::where('model', 'SubSubCategory')
            ->where('row_id', $this->attributes['id'])
            ->first();
